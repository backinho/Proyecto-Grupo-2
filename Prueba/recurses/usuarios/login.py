...
class login_class(tk.Tk):
    ...
    def botones(self):
        ...
        self.pregunta_bt = tk.Button(self, width=8, height=0, border=0, text="Registro", bg=uno, fg=cinco, command=0, font=("Segoe UI Black", 8, "bold"))
    ...
    def login_ctrl(self):
        ...
        self.pregunta = tk.Label(self, text="¿No tiene una cuenta?", width=21, bg=uno,fg=cuatro , font=("Segoe UI Black", 8))
